...
BT::NodeStatus IsRfidDetectedCondition::checkRfidStatus()
{
  ...
  if (
    (friendly_fortress_gain_point && msg->own_fortress == msg->DETECTED) ||
    (friendly_supply_zone_non_exchange &&
     msg->own_supply_zone_non_overlap_resource == msg->DETECTED) ||
    (friendly_supply_zone_exchange && msg->own_supply_zone_overlap_resource == msg->DETECTED) ||
    (center_gain_point && msg->central_rmul_only == msg->DETECTED)) {
