...
#include "pb2026_sentry_behavior/pb2026_sentry_behavior_client.hpp"
...
: Node("sentry_behavior_client", options)
{
  ...
  action_client_ = rclcpp_action::create_client<BTExecuteTree>(this, "pb2026_sentry_behavior");
...
RCLCPP_COMPONENTS_REGISTER_NODE(pb2026_sentry_behavior::SentryBehaviorClient)
