...
#include "pb2026_sentry_behavior/pb2026_sentry_behavior_server.hpp"
...
int main(int argc, char * argv[])
{
  ...
  auto action_server = std::make_shared<pb2026_sentry_behavior::SentryBehaviorServer>(options);
