...
#include "pb2026_sentry_behavior/plugins/action/send_nav2_goal.hpp"

#include "pb2026_sentry_behavior/custom_types.hpp"
...
CreateRosNodePlugin(pb2026_sentry_behavior::SendNav2GoalAction, "SendNav2Goal");
