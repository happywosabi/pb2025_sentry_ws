...
#include "pb2026_sentry_behavior/plugins/action/pub_gimbal_absolute.hpp"
...
CreateRosNodePlugin(pb2026_sentry_behavior::PublishGimbalAbsolute, "PublishGimbalAbsolute");
