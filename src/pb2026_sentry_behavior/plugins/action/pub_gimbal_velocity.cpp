...
#include "pb2026_sentry_behavior/plugins/action/pub_gimbal_velocity.hpp"
...
CreateRosNodePlugin(pb2026_sentry_behavior::PublishGimbalVelocity, "PublishGimbalVelocity");
