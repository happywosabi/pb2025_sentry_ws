...
#include "pb2026_sentry_behavior/plugins/action/calculate_attack_pose.hpp"
...
CreateRosNodePlugin(pb2026_sentry_behavior::CalculateAttackPoseAction, "CalculateAttackPose");
