...
[← 上一章：系统架构](./01_系统架构.md) | [返回主页](../README.md) | [下一章：感知层 →](./03_感知层.md)
...
graph LR
    ...
    class B,D hardwareClass
    class E,F,G,H,I dataClass
```
...
graph TB
    ...
    class F,P hardwareClass
    class H,I,J,K dataClass
    class A,B,C,D,E,G,L,M,N,O processClass
```
...
graph TB
    ...
    class E,K,O hardwareClass
    class D,P dataClass
    class A,B,C,F,G,H,I,J,L,M,N processClass
```
